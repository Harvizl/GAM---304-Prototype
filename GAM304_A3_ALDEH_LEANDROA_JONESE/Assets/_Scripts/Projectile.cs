...
public class Projectile : MonoBehaviour
{
    ...
    void Start()
    {
        sounds[0] = GameObject.Find("Enemy_Hit").GetComponent<AudioSource>();
        sounds[1] = GameObject.Find("Enemy_Explosion").GetComponent<AudioSource>();
    ...
    {
        if (other.tag.Contains ("Prawn") || other.tag.Contains ("Shrimp") || other.tag.Contains ("Jelly_Fish"))
        {
            sounds[1].Play();
        }
